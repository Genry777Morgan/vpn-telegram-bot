...
class TermsOfUseDenial extends BasePage {
  @override
  ...
  @override
  String get name => PageEnum.terms_of_use_denial.name;
  @override
  String get path => 'intro${separator}start${separator}terms_of_use${separator}terms_of_use_denial';
